...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT name_unique UNIQUE (symbol, name);
...
--
-- Name: properties at_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT at_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
